...
The code to (quickly) update the two above tables, after the (expensive) flattening step is a single [bash script](./cep.sh), where the user has just to setup few parameters before executing.
