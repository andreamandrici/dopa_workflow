...
#./a_input_pa.sh ${ncores} > logs/a_input_pa_log.txt 2>&1 wait
...
#./b_clip_pa.sh ${ncores} > logs/b_clip_pa_log.txt 2>&1 wait
...
#./c_rast_pa.sh ${ncores} > logs/c_raster_pa_log.txt 2>&1 wait
...
#./da_tiled_pa.sh ${ncores} > logs/da_tiled_pa_log.txt 2>&1 wait
...
## remake vect
./o_vector.sh ${ncores} > logs/o_vector_log.txt 2>&1 wait
