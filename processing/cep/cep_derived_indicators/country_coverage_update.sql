...
-- terrestrial
ter AS (SELECT DISTINCT qid,cid FROM cep.cep_last_index WHERE is_marine = FALSE),
-- marine
mar AS (SELECT DISTINCT qid,cid FROM cep.cep_last_index WHERE is_marine = TRUE),
