...
c AS (SELECT country_name,iso3,n2k_forest_sqkm,COALESCE(n2k_forest_pa_sqkm,0) n2k_forest_pa_sqkm FROM a LEFT JOIN b USING (country_name,iso3))
SELECT *,ROUND(((n2k_forest_pa_sqkm/n2k_forest_sqkm)*100)::numeric,2) perc FROM c ORDER BY perc DESC;
