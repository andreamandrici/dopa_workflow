...
SELECT * FROM results_202009.r_stats_cep_gfc_lossyear_over30;
...
--------------------------------------------
-- country
DROP TABLE IF EXISTS results_202009.country_change_in_forest_cover_loss; CREATE TABLE results_202009.country_change_in_forest_cover_loss AS
SELECT * FROM country_change_in_forest_cover_loss;
-- ecoregion
DROP TABLE IF EXISTS results_202009.ecoregion_change_in_forest_cover_loss; CREATE TABLE results_202009.ecoregion_change_in_forest_cover_loss AS
SELECT * FROM ecoregion_change_in_forest_cover_loss;
-- protection
DROP TABLE IF EXISTS results_202009.wdpa_change_in_forest_cover_loss; CREATE TABLE results_202009.wdpa_change_in_forest_cover_loss AS
