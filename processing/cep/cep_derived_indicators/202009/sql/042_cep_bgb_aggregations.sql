-- SELECT THE THEME;
DROP TABLE IF EXISTS theme; CREATE TEMPORARY TABLE theme AS SELECT * FROM results_202009.r_univar_cep_bgc2017_100m;
-- SELECT THE GRID;
...
-- SELECT THE AREA;
DROP TABLE IF EXISTS area_index; CREATE TEMPORARY TABLE area_index AS SELECT eid,cid,area_m2 FROM results_202009.cid_area_by_tile ORDER BY eid,cid;
------------------------------------------------------------
...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS results_202009.country_belowground_biomass_carbon;
CREATE TABLE results_202009.country_belowground_biomass_carbon AS
SELECT
...
-- ecoregion
DROP TABLE IF EXISTS results_202009.ecoregion_belowground_biomass_carbon;
CREATE TABLE results_202009.ecoregion_belowground_biomass_carbon AS
SELECT
...
-- pa
DROP TABLE IF EXISTS results_202009.wdpa_belowground_biomass_carbon;
CREATE TABLE results_202009.wdpa_belowground_biomass_carbon AS
