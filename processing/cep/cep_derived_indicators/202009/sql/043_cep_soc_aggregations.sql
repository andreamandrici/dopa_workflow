-- SELECT THE THEME;
DROP TABLE IF EXISTS theme; CREATE TEMPORARY TABLE theme AS SELECT * FROM results_202009.r_univar_cep_gsoc_tot;
-- SELECT THE GRID;
...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS results_202009.country_soil_organic_carbon;
CREATE TABLE results_202009.country_soil_organic_carbon AS
SELECT
...
-- ecoregion
DROP TABLE IF EXISTS results_202009.ecoregion_soil_organic_carbon;
CREATE TABLE results_202009.ecoregion_soil_organic_carbon AS
SELECT
...
-- pa
DROP TABLE IF EXISTS results_202009.wdpa_soil_organic_carbon;
CREATE TABLE results_202009.wdpa_soil_organic_carbon AS
