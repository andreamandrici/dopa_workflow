...
SELECT country_id country,country_name,iso3,iso2,un_m49,status FROM administrative_units.:v1;
---------------------------------------------------------------------------------------
