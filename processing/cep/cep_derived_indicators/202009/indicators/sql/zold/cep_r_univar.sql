...
-------------------------------------------------------------
-- country
DROP TABLE IF EXISTS results_202009_cep_in_cep_out.country_:v3;
CREATE TABLE results_202009_cep_in_cep_out.country_:v3 AS
...
-- ecoregion
DROP TABLE IF EXISTS results_202009_cep_in_cep_out.ecoregion_:v3;
CREATE TABLE results_202009_cep_in_cep_out.ecoregion_:v3 AS
SELECT * FROM ecoregion_tot a
LEFT JOIN ecoregion_tot_prot b USING(eco_id)
LEFT JOIN ecoregion_tot_unprot c USING(eco_id);
-- pa
DROP TABLE IF EXISTS results_202009_cep_in_cep_out.wdpa_:v3;
CREATE TABLE results_202009_cep_in_cep_out.wdpa_:v3 AS
SELECT * FROM pa;
