...
VECO="ecoregions_2020_atts" # input ecoregion
VPA="wdpa_202009" # input wdpa
VCEP="202009" # version of the processed cep; please use always the format "cep"yyyymm (here insert yyyymm)
