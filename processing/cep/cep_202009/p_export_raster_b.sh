...
SELECT DISTINCT eid FROM ${SCH}.z_grid WHERE qid IN (SELECT DISTINCT qid FROM ${SCH}.o_raster) AND eid IN (1,19,46,55,64,82,91,109,127,145,190,199,226,262,271,325,397,451,505,181,469,532) ORDER BY eid;
