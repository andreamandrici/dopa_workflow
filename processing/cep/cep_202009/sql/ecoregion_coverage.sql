DROP TABLE IF EXISTS cep202009.ecoregion_stats;CREATE TABLE cep202009.ecoregion_stats AS
WITH
-- current ecoregions
current_ecoregion AS (SELECT * FROM habitats_and_biotopes.ecoregions_2020_atts),--this defines current attributes 
